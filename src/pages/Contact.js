          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
            <div>
              ...
              <input
                ...
                style={{ width: "100%", padding: "12px 16px", border: "1.5px solid #e0e0e0", borderRadius: "10px", fontSize: "14px", fontFamily: "DM Sans, sans-serif", outline: "none" }}
              />
            </div>
            <div>
              <label style={{ fontSize: "14px", fontWeight: "600", color: "#444", display: "block", marginBottom: "6px" }}>
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                style={{ width: "100%", padding: "12px 16px", border: "1.5px solid #e0e0e0", borderRadius: "10px", fontSize: "14px", fontFamily: "DM Sans, sans-serif", outline: "none", resize: "vertical" }}
              />
            </div>
            <button
